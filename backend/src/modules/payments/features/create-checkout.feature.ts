...
export class CreateCheckoutEndpoint {
    ...
    @ApiHeader({
        ...
        required: true,
        description: 'Client-generated unique key used to enforce request idempotency.',
        schema: { type: 'string', example: 'checkout-3d4fe68b-0c0e-4de8-95cf-85f71bd27f23' },
    })
    ...
    @ApiForbiddenResponse({
        description: 'Authenticated user is not allowed by policy to create checkout.',
        schema: {
            example: {
                statusCode: 403,
